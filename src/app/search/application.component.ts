...
@Component({
  ...
  selector: 'application',  // <home></home>
...
export class Application {
  ...
  ngOnInit() {
    console.log('hello `Application` component');
  ...
  applyToJob() {
    this._searchService.createJobApplication(this.id, this.opportunity.motivationLetter)
